<%-- 
    Document   : message
    Created on : Apr 20, 2018, 9:50:00 PM
    Author     : baturay
--%>
    ...
    <div class="row">
        ...
        <div class="conversation-wrap col-lg-3">
            <form id="form-id" method="post">
                <div class="media conversation" onclick="document.getElementById('form-id').submit();" style="cursor: pointer;">
                    <input type="hidden" name="formName" value="bora" readonly="readonly"/>
                    ...
                    <div class="media-body">
                        <h5 class="media-heading">Bora Ofluoglu</h5>
                        <small>Hello</small>
                    </div>
                </div>
            </form>
                ...
                <c:forEach items="${messages}" var="message">
                    <div class="media msg">
                        ...
                        <div class="media-body">
                            ...
                            <h5 class="media-heading">${message.getReceiverUserId()}</h5>
