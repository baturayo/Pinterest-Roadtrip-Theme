        ...
        <div class="conversation-wrap col-lg-3">
            <c:forEach items="${userNames}" var="userName">
                <form id="${userName}" method="post">
                    <div class="media conversation" onclick="document.getElementById('${userName}').submit();" style="cursor: pointer;">
                        <input type="hidden" name="receiverUserName" value=${userName} readonly="readonly"/>
